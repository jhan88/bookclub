...
export default function BookCardSquare({ book }) {
  ...
  return (
    <div className="relative m-auto flex justify-center items-center h-52 w-52 rounded overflow-hidden shadow hover:shadow-lg hover:scale-105">
      ...
      <img
        ...
        className="max-h-48 aspect-[2/3] object-contain"
      />
    </div>
  );
}
